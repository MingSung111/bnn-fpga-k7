...
HD_PWD='/home/yuzou/bnn-fpga-k7/VerilogPrj/VerilogPrj.runs/wt_i_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wt_i.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wt_i.tcl
