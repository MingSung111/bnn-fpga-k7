...
#ifndef __top_mul_10ns_5ns_bek__HH__
#define __top_mul_10ns_5ns_bek__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_10ns_5ns_bek) {
    ...
    SC_CTOR(top_mul_10ns_5ns_bek):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
