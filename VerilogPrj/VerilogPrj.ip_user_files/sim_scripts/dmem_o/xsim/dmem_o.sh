...
#
# Generated by Vivado on Fri Oct 27 16:03:49 EDT 2017
# IP Build 1755317 on Mon Jan 23 20:30:07 MST 2017 
#
# usage: dmem_o.sh [-help]
# usage: dmem_o.sh [-lib_map_path]
# usage: dmem_o.sh [-noclean_files]
# usage: dmem_o.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "dmem_o.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dmem_o xil_defaultlib.dmem_o xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim dmem_o -key {Behavioral:sim_1:Functional:dmem_o} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./dmem_o.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dmem_o.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./dmem_o.sh -help\" for more information)\n"
    exit 1
  fi
