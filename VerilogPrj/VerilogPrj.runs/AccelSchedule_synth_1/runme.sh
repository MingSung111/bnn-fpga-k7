...
HD_PWD='/home/yuzou/bnn-fpga-k7/VerilogPrj/VerilogPrj.runs/AccelSchedule_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AccelSchedule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AccelSchedule.tcl
