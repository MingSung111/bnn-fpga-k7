...
#ifndef __top_mul_15ns_5ns_bfk__HH__
#define __top_mul_15ns_5ns_bfk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_15ns_5ns_bfk) {
    ...
    SC_CTOR(top_mul_15ns_5ns_bfk):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
