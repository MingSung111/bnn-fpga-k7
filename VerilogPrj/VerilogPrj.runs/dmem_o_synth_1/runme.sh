...
HD_PWD='/home/yuzou/bnn-fpga-k7/VerilogPrj/VerilogPrj.runs/dmem_o_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmem_o.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmem_o.tcl
