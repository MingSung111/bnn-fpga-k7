...
HD_PWD='/home/yuzou/bnn-fpga-k7/VerilogPrj/VerilogPrj.runs/bnn_accelerator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bnn_accelerator.tcl
