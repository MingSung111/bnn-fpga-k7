...
HD_PWD='/home/yuzou/bnn-fpga-k7/VerilogPrj/VerilogPrj.runs/kh_i_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kh_i.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kh_i.tcl
